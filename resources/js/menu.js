...
export const mainMenu = {
  ...
  menuPeople: ref([
    { id: 1, title: "Customer", icon: "mdi-circle-small", route: "/customers", permission: "viewCustomers" },
    { id: 2, title: "Supplier", icon: "mdi-circle-small", route: "/suppliers", permission: "viewSuppliers" },
    { id: 3, title: "Users", icon: "mdi-circle-small", route: "/users", permission: "viewUser" },
    { id: 4, title: "Owner", icon: "mdi-circle-small", route: "/owners", permission: "viewOwner" },
    { id: 5, title: "Loan", icon: "mdi-circle-small", route: "/loans", permission: "loanPeopleView" }
  ]),
