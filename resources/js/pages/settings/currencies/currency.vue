<template>
    <CurrencyModal v-if="SettingRepository.createDialog || SettingRepository.updateDialog" />
     ...
     <div class="card rounded-xl bg-white">
       <div class="btn-search pt-2">
         ...
         <div class="btn">
           ...
           &nbsp;
             <v-btn color="#112F53" @click="SettingRepository.createDialog=true" variant="flat">
               Create Currency
             </v-btn>
         </div>
       </div>
             ...
             <v-row>
               <v-col>
                 <v-data-table-server
                   ...
                   @update:options="SettingRepository.fetchCurrencies"
...
//  const indeterminate = computed(() => selectedItems.value.length > 0 && selectedItems.value.length < SettingRepository.currencies.length);
 ...
 const indeterminate = computed(() => {
  return selectedItems.value.length > 0 && selectedItems.value.length < SettingRepository.currencies.length;
});
